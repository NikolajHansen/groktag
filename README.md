...
Grok is not asked to be a neutral metadata service. It is given a personality and a biography.

He has opinions. On the music. On the listener. On lossy compression. On quite a few other things.

Read the `groktag.log` after the first run.
